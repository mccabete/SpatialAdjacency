...
```{r}
florida_patch <- raster("~/Downloads/LANDFIRE/Florida_both_83_and_85_US_DIST2014/US_DIST2014\\US_DIST2014.tif")
...
writeRaster(masked, "~/Downloads/LANDFIRE/croped_florida.tif")
