...
## Plot disturbence lines
 geom_line(aes(x =seq, (all_dist[[1]][2]*seq^all_dist[[1]][3])/(all_dist[[1]][1] + seq^all_dist[[1]][3])), color = disturbence_colors[6])+ #5
   geom_line(aes(x =seq, (all_dist[[2]][2]*seq^all_dist[[2]][3])/(all_dist[[2]][1] + seq^all_dist[[2]][3])), color = disturbence_colors[4])+
   geom_line(aes(x =seq, (all_dist[[3]][2]*seq^all_dist[[3]][3])/(all_dist[[3]][1] + seq^all_dist[[3]][3]) ), color = disturbence_colors[1] )+
   geom_line(aes(x =seq, (all_dist[[4]][2]*seq^all_dist[[4]][3])/(all_dist[[4]][1] + seq^all_dist[[4]][3])), color = disturbence_colors[5])+
    geom_line(aes(x =seq, (all_dist[[5]][2]*seq^all_dist[[5]][3])/(all_dist[[6]][1] + seq^all_dist[[5]][3])), color = disturbence_colors[3])+
   geom_line(aes(x =seq, (all_dist[[6]][2]*seq^all_dist[[6]][3])/(all_dist[[6]][1] + seq^all_dist[[6]][3])), color = disturbence_colors[2])+
     geom_line(aes(x =seq, (all_dist[[7]][2]*seq^all_dist[[7]][3])/(all_dist[[7]][1] + seq^all_dist[[7]][3])), color = disturbence_colors[7])+
