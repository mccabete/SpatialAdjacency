...
2*mle_output$all_dist_or[[2]]$value + 2*mle_output$all_dist_or[[3]]$value + 2*mle_output$all_dist_or[[4]]$value + 2*mle_output$all_dist_or[[5]]$value + 2*mle_output$all_dist_or[[6]]$value + 2*mle_output$all_dist_or[[7]]$value   ## model with 56 params - 24 from null so 
    LR       <- dev.null - dev.tmt        ## Likelihood ratio
    pval     <- 1 - pchisq(LR,32)  
    pval 
