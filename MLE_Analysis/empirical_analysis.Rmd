...
all_param <- optim(ic,MMLnLpower,method="Nelder-Mead", ratio = single_disturbence[null_model_conditional,]$ratio, sizw = single_disturbence[null_model_conditional,]$sizw) 

## Oregon and Florida
oregon_model_conditional <- null_model_conditional &  single_disturbence$state =="OR"
ic=c(1.416, 0.984, 0.444, 0.101)
oregon_param <- optim(ic,MMLnLpower,method="Nelder-Mead", ratio = single_disturbence[ oregon_model_conditional,]$ratio, sizw = single_disturbence[oregon_model_conditional,]$sizw)

ic=c(0.0005,0.5,1,1)
florida_model_conditional <- null_model_conditional &  single_disturbence$state =="FL"
florida_param <- optim(ic,MMLnLpower,method="Nelder-Mead",ratio = single_disturbence[florida_model_conditional,]$ratio, sizw = single_disturbence[florida_model_conditional,]$sizw)
...
ic=c(0.0005,0.5,1,1)
fl_8_3 <- optim(ic,MMLnLpower,method="Nelder-Mead", ratio = single_disturbence[conditional_fl_8_3 ,]$ratio, sizw = single_disturbence[conditional_fl_8_3,]$sizw)

fl_8_5 <- optim(ic,MMLnLpower,method="Nelder-Mead", ratio = single_disturbence[conditional_fl_8_5 ,]$ratio, sizw = single_disturbence[conditional_fl_8_5,]$sizw)

or_6_2 <- optim(ic,MMLnLpower,method="Nelder-Mead", ratio = single_disturbence[conditional_or_6_2 ,]$ratio, sizw = single_disturbence[conditional_or_6_2,]$sizw)

or_7_1 <- optim(ic,MMLnLpower,method="Nelder-Mead", ratio = single_disturbence[conditional_or_7_1 ,]$ratio, sizw = single_disturbence[conditional_or_7_1,]$sizw)
...
run_optim <- function (conditional, disturbences_names){
  ...
  PR <-  optim(ic,MMLnLpower,method="Nelder-Mead", ratio = single_disturbence[conditional,]$ratio, sizw = na.omit(single_disturbence[conditional,]$sizw))
  return(PR)
}
