...
nt=300
time = 0:nt
hist(ages+0.001,probability = TRUE,xlim=c(0,nt),breaks=nt,xlab="Age (years)",main="Gap Dynamics")
...
ages.gap = ages
save(ages.gap,file="ages.gap.RData")
```
...
nt=100
time = 0:nt
hist(ages.spread+0.0001,probability = TRUE,xlim=c(0,nt),breaks=0:years,xlab="Age (years)",main="Contagious Spread")
