...
Southern_coastal_plains <- eco_II[eco_II$NA_L2NAME == "SOUTHEASTERN USA PLAINS", ]
...
print("Writing subset tif")
writeRaster(masked, "/usr3/graduate/tmccabe/mccabete/spatialadjacentcy/LANDFIRE/Florida/Florida_8_3_2014.tif")
