...
Southern_coastal_plains <- eco_II[eco_II$NA_L2NAME == "WESTERN CORDILLERA", ]
...
writeRaster(masked, "/usr3/graduate/tmccabe/mccabete/spatialadjacentcy/LANDFIRE/Oregon/Oregon_6_2_2014.tif")
