...
test <- raster("/usr3/graduate/tmccabe/mccabete/spatialadjacentcy/LANDFIRE/Florida/lf70263747_US_DIST2014/US_DIST2014\\US_DIST2014.tif")
...
write.csv(Fire_2000,"/usr3/graduate/tmccabe/mccabete/spatialadjacentcy/LANDFIRE/Florida_2014.csv" )
